...
conditionhybride <- function(tabnum, tabbool, carte, seuil) {
...
score_double<- function(a=3,b=4, seuil1,seuil2,fun1,fun2,conditionj1,conditionj2){
  init<-initial2()
  ...
  while(bool1 && bool2){
    if(sum(tabbool1)!=12){
      ...
      if (fun1(tabnum1,tabbool1,defausse, seuil1)){
        #print(1)
        a<-conditionj1(tabnum1,tabbool1,defausse,seuil1)
        if(a[1]==-1){
          #print(-1)
          #print(sum(tabbool1))
          posi<-place(tabbool1)
        ...
        #print(sum(tabbool1))
        a<-conditionj1(tabnum1,tabbool1,u,seuil1)
        if(a[1]==-1){
          posi<-place(tabbool1)
          tmp <- tabnum1[posi[1],posi[2]]
          tabbool1[posi[1],posi[2]] <- 1
    ...
    if(sum(tabbool2)!=12){
      ...
      if (fun2(tabnum2,tabbool2,defausse, seuil2)){
        #print(3)
        a<-conditionj2(tabnum2,tabbool2,defausse,seuil2)
        if(a[1]==-1){
          posi<-place(tabbool2)
        ...
        a<-conditionj2(tabnum2,tabbool2,v,seuil2)
        #print(4)
        if(a[1]==-1){
          posi<-place(tabbool2)
          tmp <- tabnum2[posi[1],posi[2]]
...
sc_moy_tot <- function(n, seuil1,seuil2,fun1,fun2,conditionj1,conditionj2) {
  aa<-list()
  resultats<- replicate(n,{
    setTxtProgressBar(pb, getTxtProgressBar(pb) + 1) 
    return(score_double(3, 4, seuil1,seuil2,fun1,fun2,conditionj1,conditionj2))
    })
  #print(resultats)
...
replicate(10 , score_double(3, 4, 2,2,condhybride,condhybride,conditionhybride,conditionhybride))
#time <- Sys.time()
replicate(10, score_double(3, 4, 2,2,condseuilposmax,condseuilposmax,conditionseuilposmax,conditionseuilposmax))

#score_double<- function(a=3,b=4, seuil1,seuil2,fun1,fun2,conditionj1,conditionj2)
#condseuilposmax
#condhybride
#conditionseuilposmax
#conditionhybride
pb <- txtProgressBar(min = 0, max = n, style = 3)

spm2_spm2<-sc_moy_tot(10000, 2,2,condseuilposmax,condseuilposmax,conditionseuilposmax,conditionseuilposmax)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
spm2_spm3<-sc_moy_tot(10000, 2,3,condseuilposmax,condseuilposmax,conditionseuilposmax,conditionseuilposmax)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
spm3_spm2<-sc_moy_tot(10000, 3,2,condseuilposmax,condseuilposmax,conditionseuilposmax,conditionseuilposmax)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
spm3_spm3<-sc_moy_tot(10000, 3,3,condseuilposmax,condseuilposmax,conditionseuilposmax,conditionseuilposmax)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
spm2_hyb2<-sc_moy_tot(10000, 2,2,condseuilposmax,condhybride,conditionseuilposmax,conditionhybride)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
spm2_hyb3<-sc_moy_tot(10000, 2,3,condseuilposmax,condhybride,conditionseuilposmax,conditionhybride)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
spm3_hyb2<-sc_moy_tot(10000, 3,2,condseuilposmax,condhybride,conditionseuilposmax,conditionhybride)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
spm3_hyb3<-sc_moy_tot(10000, 3,3,condseuilposmax,condhybride,conditionseuilposmax,conditionhybride)
close(pb)
...
pb <- txtProgressBar(min = 0, max = n, style = 3)
hyb2_hyb2<-sc_moy_tot(10000, 2,2,condhybride,condhybride,conditionhybride,conditionhybride)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
hyb2_hyb3<-sc_moy_tot(10000, 2,3,condhybride,condhybride,conditionhybride,conditionhybride)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
hyb3_hyb2<-sc_moy_tot(10000, 3,2,condhybride,condhybride,conditionhybride,conditionhybride)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
hyb2_spm2<-sc_moy_tot(10000, 2,2,condhybride,condseuilposmax,conditionhybride,conditionseuilposmax)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
hyb2_spm3<-sc_moy_tot(10000, 2,3,condhybride,condseuilposmax,conditionhybride,conditionseuilposmax)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
hyb3_spm2<-sc_moy_tot(10000, 3,2,condhybride,condseuilposmax,conditionhybride,conditionseuilposmax)
close(pb)

pb <- txtProgressBar(min = 0, max = n, style = 3)
hyb3_hyb3<-sc_moy_tot(10000, 3,3,condhybride,condhybride,conditionhybride,conditionhybride)
close(pb)
